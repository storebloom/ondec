...
$userstatus = get_user_meta($current_user->ID, 'userstatus', true);
		...
		<main id="main" class="site-main" role="main">
            ...
            <div class="user-wrapper">
                <div class="user-information">
                    ...
                    <input class="<?php if($decstatus === "ondec"){ echo "currently-ondec"; } else { echo "currently-offdec"; } ?>" id="submit-decstatus" type="button" value="<?php echo "Currently " . $decstatus; ?>">
